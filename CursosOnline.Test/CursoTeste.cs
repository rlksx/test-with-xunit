   ...
   */
   ...
   public void CursoCargaHorariaInvalida(int cargaHoraria)
   {
      ...
      Assert
           ...
           */
          .Message.Equals("Valor inv�lido para Carga Hor�ria!");
   }
...
public class Curso
{
   ...
   {
      if (string.IsNullOrEmpty(name)) throw new ArgumentException("Preenchimento do nome do curso � obrigat�rio!");
      if (cargaHoraria <= 0) throw new ArgumentException("Valor inv�lido para Carga Hor�ria!");
      if (nota < 0) throw new ArgumentException("Nota Inválida!");
